...
export function ReportDetail() {
  ...
  return (
    <div className="space-y-4 w-full pb-10">
      ...
      {/* 2. Tam genişlikte canlı bülten önizlemesi */}
      <div className="grid grid-cols-1 lg:grid-cols-10 gap-4 items-start">
        <div
          data-testid="report-preview"
          className="lg:col-span-10 flex flex-col bg-white rounded-2xl border border-slate-200/90 shadow-2xs h-[850px] overflow-hidden"
        >
