...
export function buildPatchSystemInstruction(): string {
  return [
    ...
    'outcome=NEEDS_ANALYSIS yalnızca talep, mevcut alanlarda bulunmayan yeni bir olgu gerektiriyorsa kullanılır: kaynakta aranması gereken yeni bir tarih veya oran, yeni bir kaynak, yeni bir etkilenen taraf, tablo satır/sütun yapısının değişmesi.',
