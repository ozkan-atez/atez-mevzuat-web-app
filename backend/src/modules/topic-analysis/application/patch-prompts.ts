...
export function buildPatchSystemInstruction(): string {
  return [
    ...
    'Talep kanıta dayalı bir olguyu değiştiriyorsa (yeni tarih, farklı oran, yeni kaynak, yeni etkilenen taraf, tablo yapısı) outcome=NEEDS_ANALYSIS döndür ve edits boş kalsın.',
    ...
    'Yalnızca metin düzeltmesi, yeniden ifade etme veya biçim düzeltmesi isteniyorsa outcome=EDITS döndür.',
